        ...
        <header class="dashboard-header d-flex justify-content-between align-items-center mb-4 pt-3">
            ...
            <div class="d-flex align-items-center">
                <span class="me-3 text-secondary">Logged in as: <span
                        class="fw-bold text-success"><?= htmlspecialchars($labtechName) ?></span></span>
                <a href="logout.php" class="btn btn-outline-secondary btn-sm rounded-pill"><i
        ...
        <form method="get" class="filter-form d-flex align-items-center gap-2">
            ...
            <select name="lab_name" id="lab_name" class="form-select form-select-sm w-auto">
                ...
                <?php foreach ($labs as $lab): ?>
                    <option value="<?= htmlspecialchars($lab) ?>" <?= ($lab === $labFilter) ? 'selected' : '' ?>>
                        ...
                        <tbody>
                            <?php foreach ($odApplications as $od): ?>
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars($od['year']) ?>/<?= htmlspecialchars($od['department']) ?>/<?= htmlspecialchars($od['section']) ?>
                                    </td>
                                    <td><span
                                            class="badge bg-info text-dark"><?= htmlspecialchars(ucfirst($od['od_type'])) ?></span>
                                    </td>
                                    <td class="small">
                                        <?php
