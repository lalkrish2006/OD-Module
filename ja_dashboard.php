...
$jaName = $_SESSION['user']['name']; // store logged-in JA's name
...
<body>
    <div class="container py-4">
        ...
        <h2 class="mb-4 text-center text-primary fw-bold">JA Dashboard</h2>

        <?php if (empty($applications)): ?>
            <div class="alert alert-info text-center">No OD requests available for JA review.</div>
        <?php else: ?>
